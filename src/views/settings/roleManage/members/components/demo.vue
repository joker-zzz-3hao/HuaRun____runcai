        ...
        <el-scrollbar>
          <ul class="txt-list">
            <!-- <li v-for="(item,index) in data" :key="index" @click="getqueryOrgAndUser(item)">
              <el-checkbox class="tl-checkbox" v-if="item.type=='USER'">
                <div class="img-user">
              ...
              <em v-if="item.type !=='USER'">{{item.name}}</em>
              <i v-if="item.type !=='USER'" class="el-icon-arrow-right"></i>
            </li>-->
            <li>
              <em>张山</em>
