      ...
      handler(data) {
        ...
        this.server.queryOrgAdmin({
          ...
          if (res.data.orgAdminUserName == this.rowData.userName) {
            this.$alert(`'${res.data.orgAdminUserName}'已经是该部门负责人，不能设置为该部门的代理负责人。`, '提示', {
            ...
            this.$alert(`'${res.data.orgAdminUserName}'已经是该部门综合岗，不能设置为该部门的代理负责人。`, '提示', {
              confirmButtonText: '取消',
              type: 'warning',
              closeOnClickModal: false,
              callback: () => {
            ...
            this.$confirm(`当前部门已经存在代理负责人'${res.data.orgAdminUserName}',是否将其替换？`, '提示', {
