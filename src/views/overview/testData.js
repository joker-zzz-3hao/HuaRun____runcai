const mainData = {
  ...
  mainDataX: ['凌云', '行云', '捷云', '容云', '门户', '合云', '耕云', '运营推广部', '运维管理'],
  mainCount: [80, 40, 20, 40, 80, 40, 20, 70, 30],
  moodData: [['凌云', 10, 40, 30], ['行云', 10, 30, 20], ['捷云', 10, 24, 20], ['容云', 10, 20, 15], ['门户', 10, 20, 10], ['耕云', 10, 30, 10], ['运营推广部', 10, 20, 40], ['运维管理', 10, 30, 40]],
  orkData: {
    code: 200,
...
const teamData = {
  ...
  mainDataX: ['刘林', '周明明', '张小萍', '林衣衣', '唐娅', '刘伊汶', '唐帅', '许雨', '王逸坤', '曾伟明', '张丽丽', '徐明', '车晓慧', '徐佳佳', '许哲民', '肖青', '熊彬', '欧阳娜娜', '滕伟', '曾智勇', '王伟', '文娟', '张天龙', '候敏', '滕伟', '曾智勇', '王伟', '文娟', '张天龙', '候敏', '张天龙', '候敏'],
  // eslint-disable-next-line max-len
  ...
  mainDatapreX: ['陆涛', '徐佳佳', '许哲民', '肖青', '熊彬', '欧阳娜娜', '滕伟', '曾智勇', '王伟', '文娟', '张天龙', '候敏'],
  ...
  roundData: {
    ...
    msg: 'response.success',
    data: [{
      riskName: '无风险', riskCode: 1, count: 40, ratio: '40',
    }, {
      riskName: '风险可控', riskCode: 2, count: 30, ratio: '30',
    }, {
